...
const CONVERSATIONS = {
  ...
  B: {
    "Papa": [
      { from: "Papa", text: "Tu as bien mis ton cahier de maths ?", when: "20/11 18:22" },
      { from: "Moi",  text: "Oui !", when: "20/11 18:23" },

      { from: "Papa", text: "Donne à Cookie sa gamelle en rentrant 🐾 (et pense au devoir).", when: "Aujourd’hui 07:58" },
      { from: "Moi",  text: "Ok 👍", when: "Aujourd’hui 07:59" }
    ],
    "Maman": [
      { from: "Maman", text: "Je pars tôt demain.", when: "03/12 20:02" },
      { from: "Maman", text: "Active l'alarme avant de dormir.", when: "03/12 20:05" },
      { from: "Moi",   text: "Ok.", when: "03/12 20:06" },
      { from: "Maman", text: "Le code : 7042 (à garder pour toi).", when: "03/12 20:07" }
    ],
    "Clara": [
      { from: "Clara", text: "Tu peux me rappeler le devoir d’anglais ?", when: "16/10 18:10" },
      { from: "Moi",   text: "Oui, page 42 ex 3.", when: "16/10 18:11" },

      { from: "Clara", text: "On va au parc des sports mercredi ?", when: "Hier 18:44" },
      { from: "Moi",   text: "Oui !", when: "Hier 18:45" },
      { from: "Clara", text: "16h ?", when: "Hier 18:46" },
      { from: "Moi",   text: "Ok 👍", when: "Hier 18:47" }
    ],
    "Mamie": [
      { from: "Mamie", text: "Tu me montres ton dessin ce week-end ? 😊", when: "07/09 10:15" },
      { from: "Moi",   text: "Oui mamie !", when: "07/09 10:16" },
      { from: "Mamie", text: "On fera aussi un petit gâteau.", when: "07/09 10:17" }
    ]
  }
};
