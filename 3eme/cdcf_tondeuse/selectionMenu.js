...
melangerArray(elementsCompatibles);
        ...
        if (mode === "portrait") {
            button.style.fontSize = "2.2vw";
        } else { button.style.fontSize = "1.1vw";
        }
...
function ajusterLargeurMenu(selectionMenu, zone) {
    ...
    if (mode === "portrait") {
        minMenuWidth = (tailleZone === "grande") ? screenWidth * 0.30 : screenWidth * 0.2; // 40% si grande, 25% si petite
        maxMenuWidth = screenWidth * 0.50; // Max toujours 50% en portrait
    } else {
        minMenuWidth = (tailleZone === "grande") ? screenWidth * 0.22 : screenWidth * 0.12; // 25% si grande, 15% si petite
